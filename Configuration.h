...
#define STRING_CONFIG_H_AUTHOR "(Suterusu)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 11.54
  #define DEFAULT_Ki 0.78
  #define DEFAULT_Kd 42.91
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 31, 14, 0 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (((X_BED_SIZE) / 2) +0)  // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (((Y_BED_SIZE) / 2) +45)  // Y point for Z homing when homing all axes (G28).
#endif
